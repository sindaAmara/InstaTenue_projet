    ...
    themes: [
      {
        ...
        articles: [
          [
            { label: 'Haut', name: 'Chemise Bleue', price: '35 €', brand: 'Zara', ref: 'ZAR-AUT-H01', image: require('../assets/img/automne/chic/chemise_bleu_rayure.jpeg') },
            { label: 'Haut', name: 'Pull bleu', price: '25 €', brand: 'H&M', ref: 'HM-AUT-H02', image: require('../assets/img/automne/chic/pull_bleu.jpeg') },
            { label: 'Bas', name: 'Jean ', price: '39 €', brand: 'Levi\'s', ref: 'LEV-AUT-B01', image: require('../assets/img/automne/chic/jean_bleu_foncé.jpeg') },
            { label: 'Accessoire', name: 'Ceinture', price: '12 €', brand: 'Mango', ref: 'MAN-AUT-A01', image: require('../assets/img/automne/chic/ceinture_marron.jpeg') },
            { label: 'Sac', name: 'Sac', price: '25 €', brand: 'Stradivarius', ref: 'STR-AUT-S01', image: require('../assets/img/automne/chic/sac_marron.jpeg') },
          ],
          [
            { label: 'Haut', name: 'Pull Beige', price: '39 €', brand: 'Uniqlo', ref: 'UNI-AUT-H03', image: require('../assets/img/automne/chic/pull_blanc.jpeg') },
            { label: 'Bas', name: 'Pantalon noir', price: '59 €', brand: 'Zara', ref: 'ZAR-AUT-B02', image: require('../assets/img/automne/chic/pantalon_noir.jpeg') },
            { label: 'Accessoire', name: 'Coque ', price: '5 €', brand: 'Shein', ref: 'SHE-AUT-A02', image: require('../assets/img/automne/chic/coque.jpeg') },
            { label: 'Chaussures', name: 'Baskets', price: '120 €', brand: 'Nike', ref: 'NIK-AUT-C01', image: require('../assets/img/automne/chic/chaussure_blanc.jpeg') },
            { label: 'Accessoire', name: 'Boucles doreilles', price: '25 €', brand: 'Claire\'s', ref: 'CLA-AUT-A03', image: require('../assets/img/automne/chic/boucle_oreille.jpeg') },
          ],
          [
            { label: 'Haut', name: 'Chemise blanche', price: '39 €', brand: 'H&M', ref: 'HM-AUT-H04', image: require('../assets/img/automne/chic/chemise_blanc.jpeg') },
            { label: 'Bas', name: 'Pantalon gris', price: '59 €', brand: 'Pull&Bear', ref: 'PB-AUT-B03', image: require('../assets/img/automne/chic/pantalon_gris.jpeg') },
            { label: 'Sac', name: 'Sac ', price: '89 €', brand: 'Zara', ref: 'ZAR-AUT-S02', image: require('../assets/img/automne/chic/sac_rouge.jpeg') },
            { label: 'Accessoire', name: 'Foulard', price: '13 €', brand: 'Mango', ref: 'MAN-AUT-A04', image: require('../assets/img/automne/chic/foulard.jpeg') },
            { label: 'Accessoire', name: 'Ceinture', price: '25 €', brand: 'Stradivarius', ref: 'STR-AUT-A05', image: require('../assets/img/automne/chic/ceinture_noir.jpeg') },
          ],
        ],
      },
      {
        ...
        articles: [
          [
            { label: 'Accessoire', name: 'Casquette grise', price: '35 €', brand: 'Nike', ref: 'NIK-AUT-A06', image: require('../assets/img/automne/sport/casquette_gris.jpeg') },
            { label: 'Haut', name: 'Sweat bleu', price: '25 €', brand: 'Adidas', ref: 'ADI-AUT-H05', image: require('../assets/img/automne/sport/sweat_bleu.jpeg') },
            { label: 'Haut', name: 'T-shirt blanc ', price: '9 €', brand: 'Uniqlo', ref: 'UNI-AUT-H06', image: require('../assets/img/automne/sport/t_shirt_blanc_large.jpeg') },
            { label: 'Bas', name: 'Jean bleu', price: '35 €', brand: 'Pull&Bear', ref: 'PB-AUT-B04', image: require('../assets/img/automne/sport/jean_bleu_clair.jpeg') },
            { label: 'Chaussures', name: 'Baskets', price: '250 €', brand: 'New Balance', ref: 'NB-AUT-C02', image: require('../assets/img/automne/sport/chaussures_blanc.jpeg') },
          ],
          [
            { label: 'Accessoire', name: 'Casquette noire', price: '35 €', brand: 'Nike', ref: 'NIK-AUT-A07', image: require('../assets/img/automne/sport/casquette_noir.jpeg') },
            { label: 'Haut', name: 'Sweat noir', price: '59 €', brand: 'Nike', ref: 'NIK-AUT-H07', image: require('../assets/img/automne/sport/sweat_noir_nike.jpeg') },
            { label: 'Bas', name: 'Legging noir ', price: '18 €', brand: 'Gymshark', ref: 'GYM-AUT-B05', image: require('../assets/img/automne/sport/legging_noir.jpeg') },
            { label: 'Chaussures', name: 'Baskets', price: '120 €', brand: 'Adidas', ref: 'ADI-AUT-C03', image: require('../assets/img/automne/sport/chaussures_blanc.jpeg') },
            { label: 'Accessoire', name: 'Sac noir', price: '25 €', brand: 'Puma', ref: 'PUM-AUT-S01', image: require('../assets/img/automne/sport/sac_noir.jpeg') },
          ],
          [
            { label: 'Haut', name: 'Sweat gris', price: '39 €', brand: 'H&M', ref: 'HM-AUT-H08', image: require('../assets/img/automne/sport/sweat_gris.jpeg') },
            { label: 'Haut', name: 'T shirt blanc', price: '25 €', brand: 'Uniqlo', ref: 'UNI-AUT-H09', image: require('../assets/img/automne/sport/t_shirt_blanc_large.jpeg') },
            { label: 'Bas', name: 'Jogging noir', price: '59 €', brand: 'Nike', ref: 'NIK-AUT-B06', image: require('../assets/img/automne/sport/pantalon_noir.jpeg') },
            { label: 'Chaussures', name: 'Baskets noires ', price: '89 €', brand: 'Adidas', ref: 'ADI-AUT-C04', image: require('../assets/img/automne/sport/chaussures_blanc.jpeg') },
            { label: 'Accessoire', name: 'Boucles oreilles', price: '13 €', brand: 'Claire\'s', ref: 'CLA-AUT-A08', image: require('../assets/img/automne/sport/boucle_oreille.jpeg') },
          ],
        ],
      },
    ],
    ...
    themes: [
      {
        ...
        articles: [
          [
            { label: 'Accessoire', name: 'Lunettes noires', price: '35 €', brand: 'Ray-Ban', ref: 'RB-HIV-A01', image: require('../assets/img/hiver/chic/lunette.jpeg') },
            { label: 'Accessoire', name: 'Manteau noir', price: '250 €', brand: 'Zara', ref: 'ZAR-HIV-H01', image: require('../assets/img/hiver/chic/manteau_noir.jpeg') },
            { label: 'Haut', name: 'Pull noir', price: '39 €', brand: 'Uniqlo', ref: 'UNI-HIV-H02', image: require('../assets/img/hiver/chic/pull_noir.jpeg') },
            { label: 'Bas', name: 'Jean bleu', price: '49 €', brand: 'Levi\'s', ref: 'LEV-HIV-B01', image: require('../assets/img/hiver/chic/jean_bleu.jpeg') },
            { label: 'Chaussures', name: 'Samba', price: '100 €', brand: 'Adidas', ref: 'ADI-HIV-C01', image: require('../assets/img/hiver/chic/chaussures.jpeg') },
          ],
          [
            { label: 'Accessoire', name: 'Lunettes', price: '39 €', brand: 'Ray-Ban', ref: 'RB-HIV-A02', image: require('../assets/img/hiver/chic/lunette.jpeg') },
            { label: 'Accessoire', name: 'Manteau bleu', price: '59 €', brand: 'H&M', ref: 'HM-HIV-H03', image: require('../assets/img/hiver/chic/manteau_bleu.jpeg') },
            { label: 'Haut', name: 'Pull blanc', price: '59 €', brand: 'Uniqlo', ref: 'UNI-HIV-H04', image: require('../assets/img/hiver/chic/pull_blanc.jpeg') },
            { label: 'Bas', name: 'Pantalon blanc', price: '50 €', brand: 'Zara', ref: 'ZAR-HIV-B02', image: require('../assets/img/hiver/chic/pantalon_blanc.jpeg') },
            { label: 'Sac', name: 'Sac bleu', price: '250 €', brand: 'Dior', ref: 'DIO-HIV-S01', image: require('../assets/img/hiver/chic/sac_dior.jpeg') },
          ],
          [
            { label: 'Haut', name: 'Pull noir', price: '39 €', brand: 'Uniqlo', ref: 'UNI-HIV-H05', image: require('../assets/img/hiver/chic/pull_noir.jpeg') },
            { label: 'Accessoire', name: 'Manteau', price: '59 €', brand: 'Zara', ref: 'ZAR-HIV-H06', image: require('../assets/img/hiver/chic/manteau_marron.jpeg') },
            { label: 'Accessoire', name: 'Ceinture ', price: '29 €', brand: 'Mango', ref: 'MAN-HIV-A03', image: require('../assets/img/hiver/chic/ceinture_noir.jpeg') },
            { label: 'Bas', name: 'Jean', price: '50 €', brand: 'Levi\'s', ref: 'LEV-HIV-B03', image: require('../assets/img/hiver/chic/jean_bleu.jpeg') },
            { label: 'Sac', name: 'Sac', price: '25 €', brand: 'Stradivarius', ref: 'STR-HIV-S02', image: require('../assets/img/hiver/chic/sac_noir.jpeg') },
          ],
        ],
      },
      {
        ...
        articles: [
          [
            { label: 'Accessoire', name: 'Boucles oreilles', price: '35 €', brand: 'Claire\'s', ref: 'CLA-HIV-A04', image: require('../assets/img/hiver/sport/creole.jpeg') },
            { label: 'Haut', name: 'Sweat noir', price: '250 €', brand: 'Nike', ref: 'NIK-HIV-H07', image: require('../assets/img/hiver/sport/sweat_noir.jpeg') },
            { label: 'Bas', name: 'Jogging noir', price: '39 €', brand: 'Adidas', ref: 'ADI-HIV-B04', image: require('../assets/img/hiver/sport/jogging_noir.jpeg') },
            { label: 'Accessoire', name: 'Chaussettes blanches', price: '49 €', brand: 'Stance', ref: 'STA-HIV-A05', image: require('../assets/img/hiver/sport/chaussette.jpeg') },
            { label: 'Chaussures', name: 'Samba', price: '100 €', brand: 'Adidas', ref: 'ADI-HIV-C05', image: require('../assets/img/hiver/sport/chaussures.jpeg') },
          ],
          [
            { label: 'Accessoire', name: 'Veste bleue', price: '39 €', brand: 'Nike', ref: 'NIK-HIV-H08', image: require('../assets/img/hiver/sport/veste_bleu.jpeg') },
            { label: 'Haut', name: 'Sweat bleu', price: '59 €', brand: 'Adidas', ref: 'ADI-HIV-H09', image: require('../assets/img/hiver/sport/sweat_bleu.jpeg') },
            { label: 'Bas', name: 'Jean noir', price: '59 €', brand: 'Levi\'s', ref: 'LEV-HIV-B05', image: require('../assets/img/hiver/sport/jean_noir.jpeg') },
            { label: 'Accessoire', name: 'Sac noir', price: '50 €', brand: 'Puma', ref: 'PUM-HIV-S03', image: require('../assets/img/hiver/sport/sac_noir.jpeg') },
            { label: 'Accessoire', name: 'Chaussures bleues', price: '250 €', brand: 'Nike', ref: 'NIK-HIV-C06', image: require('../assets/img/hiver/sport/chaussure_bleu.jpeg') },
          ],
          [
            { label: 'Haut', name: 'Bandeau blanc', price: '8 €', brand: 'Nike', ref: 'NIK-HIV-A06', image: require('../assets/img/hiver/sport/bandeau.jpeg') },
            { label: 'Haut', name: 'Veste noir', price: '59 €', brand: 'Adidas', ref: 'ADI-HIV-H10', image: require('../assets/img/hiver/sport/veste_noir.jpeg') },
            { label: 'Bas', name: 'Legging noir ', price: '19 €', brand: 'Gymshark', ref: 'GYM-HIV-B06', image: require('../assets/img/hiver/sport/legging_noir.jpeg') },
            { label: 'Sac', name: 'Sac noir', price: '15 €', brand: 'Puma', ref: 'PUM-HIV-S04', image: require('../assets/img/hiver/sport/sac_noir.jpeg') },
            { label: 'Chaussures', name: 'Chaussures blanches', price: '100 €', brand: 'Adidas', ref: 'ADI-HIV-C07', image: require('../assets/img/hiver/sport/chaussures.jpeg') },
          ],
        ],
      },
    ],
